...
urlpatterns = patterns('',
    ...
    page('contribute/a', 'mozorg/contribute/index-a.html'),
    page('contribute/a2', 'mozorg/contribute/index-a2.html'),
    page('contribute/b', 'mozorg/contribute/index-b.html'),
    page('contribute/c', 'mozorg/contribute/index-c.html'),
    page('contribute/inquiry', 'mozorg/contribute/inquiry.html'),
    page('contribute/events', 'mozorg/contribute/events.html'),
    page('contribute/events/detail', 'mozorg/contribute/event-detail.html'),
    page('contribute/stories', 'mozorg/contribute/stories.html'),
    page('contribute/tasks', 'mozorg/contribute/tasks.html'),
